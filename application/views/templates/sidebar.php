        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('dashboard') ?>">
                <div class="sidebar-brand-icon ">
                    <img src="<?php echo base_url('assets/img/logokuuuuuuuuu.jpg') ?>" width="60" height="60">
                </div>
                <div class="sidebar-brand-text mx-3">Toko Ohlaine</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/logo') ?>">
                    <img src="<?php echo base_url('assets/img/logokuuuuuuuuu.jpg') ?>" width="25" height="25">
                    <span>Logo</span></a>
            </li>
                ...
                <div class="topbar-divider d-none d-sm-block"></div>
                        ...
                        <ul class="na navbar-nav navbar-right">
                            <?php if($this->session->userdata('username')) { ?>
                                ...
                                <button type="button" class="btn bg-gradient-dark ml-4"><?php echo anchor('auth/login', 'Logoutsss'); ?></button>
                            <?php } else { ?>
