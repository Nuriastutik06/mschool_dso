...
<br>
    <div class="text-center" style="font-size: 35px;">
        <img src="<?php echo base_url().'theme/images/sijaka.jpeg'?>" class="img-fluid about-img" style="margin-left: ;" style="display: block; margin: auto;"  alt="#"><br><br>
        <strong>SOFTWARE SIJAKA</strong>
    </div>
        ...
        <div class="row">
            <div class="col-md-8">
               <p style="text-align:left;">
                Simpanan berjaka merupakan simpanan yang diberikan untuk jangka waktu yang telah disepakati dan dana tidak bisa diambil sampai batas waktu tersebut. Sebelum melakukan simpanan berjaka, perjanjian telah dilakukan antara penyimpanan dengan pihak koperasi. Dari perjanjian-perjanjian tersebut juga memiliki aturan, seperti :<br>
                Koperasi memiliki syarat pada penyimpanan bahwa calon penyimpan harus menjadi penabung terlebih dahulu sebelum memilih simpanan berjaka.<br>
                   Koperasi menetapkan jumlah setoran minimal setiap waktu pembayarannya<br>
                   Koperasi akan memberikan bonus atau imbalan pada simpanan berdasarkan jangka waktu tersebut.<br>
                   Bonus simpanan yang akan diberikan merupakan jumlah perhitungan laba koperasi pada setiap bulannya. Koperasi akan membayarkan bonus setiap akhir bulan dan langsung ditambahkan ke dalam saldo tabungan.<br>
                   Pokok SIJAKA tidak bisa diambil secara berkala. Pokok SIJAKA hanya bisa diambil pada waktu habis jangkanya.<br>
                   software modul SIJAKA berfungsi : untuk mengelola sistem informasi manajemen simpanan berjangka, adapun fitur utama simpanan berjaka adalah :<br>
                   1. Input SIJAKA<br>
                   2. Cetak surat/bukti<br>
                   3. Postingan bagi hasil<br>
                   4. Laporan manajemen<br><br>
               </p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                 <div class="col-md-4 text-center item-block">
                    <i class="fa fa-users fa-5x" style="color: blue"></i>
                    <p><h4><strong>SOFTWARE KEANGGOTAAN </strong></h4></p>
                    <p>Software Keanggotaan Koperasi.</p> <br> 
                    <p><a href="<?php echo base_url().'#'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p>
                </div>
                <div class="col-md-4 text-center item-block">
                    <i class="fas fa-dollar-sign fa-5x" style="color: blue"></i>
                    <p><h4><strong>SOFTWARE SIMPANAN</strong></h4></p>
                    <p>Program Simpanan Sukarela Anggota.</p> <br> 
                    <p><a href="<?php echo base_url().'#'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p>
                </div>
                <div class="col-md-4 text-center item-block">
                    <i class="fas fa-money-check-alt fa-5x" style="color: blue"></i>
                    <p><h4><strong>SOFTWARE SIJAKA</strong></h4></p>
                    <p>SIJAKA (SIMPANAN BERJANGKA).</p> <br>
                    <p><a href="<?php echo base_url().'#'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p> <br> <br> <br> <br>
                </div>
                <div class="col-md-4 text-center item-block">
                    <i class="fas fa-credit-card fa-5x" style="color: blue"></i>
                    <p><h4><strong>SOFTWARE KREDIT</strong></h4></p>
                    <p>Software Kredit/Utang Piutang.</p> <br>
                    <p><a href="<?php echo base_url().'#'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p>
                </div>
                <div class="col-md-4 text-center item-block">
                    <i class="fas fa-calculator fa-5x" style="color: blue"></i>
                    <p><h4><strong>SOFTWARE AKUNTANSI</strong></h4></p>
                    <p>Software Akuntansi.</p> <br>
                    <p><a href="<?php echo base_url().'#'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p>
                </div>
                <div class="col-md-4 text-center item-block">
                    <i class="fas fa-database fa-5x" style="color: blue"></i>
                    <p><h4><strong>Database MIGRATION</strong></h4></p>
