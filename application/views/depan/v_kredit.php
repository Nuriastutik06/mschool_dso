...
<br>
    <div class="text-center" style="font-size: 35px;">
        <img src="<?php echo base_url().'theme/images/kredit.jpg'?>" class="img-fluid about-img" style="margin-left: ;" style="display: block; margin: auto;"  alt="#"><br><br>
        <strong>SOFTWARE KREDIT</strong>
    </div>
        ...
        <div class="row">
            <div class="col-md-8">
               <p style="text-align:left;">
                Kredit / piutang merupakan pinjaman yang diberikan kepada anggota koperasi untuk jangka waktu yang telah disepakati dan ada biaya yang timbul. Sebelum melakukan realisasi pinjaman/kredit terlebih dahulu dilakukan perjanjian antara koperasi dan peminjaman / anggota. Dari perjanjian-perjanjian tersebut juga memiliki aturan secara umum, seperti :
                <p style="text-align:left;">
                    Nilai besaran dana yang di pinjamkan oleh koperasi kepada anggota,<br>Jangka waktu pengembalian pinjaman,<br>Dan lain-lain yang dirasa diperlukan.<br>
                    software modul KREDIT berfungsi : untuk mengelola sistem informasi manajemen pengendalian kredit, adapun fitur utama modul kredit adalah :
                </p>
                <br>
                   1. Input realisasi pinjaman<br>
                   2. Cetak perjanjian<br>
                   3. Input angsuran pinjaman<br>
