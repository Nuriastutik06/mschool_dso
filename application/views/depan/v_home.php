        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            ...
                            <h4><strong>Simpanan sukarela merupakan dana yang disetorkan secara berangsur-angsur kepada koperasi selama menjadi anggota.</strong></h4>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1><strong>Module Anggota</strong></h1>
                            <h4><strong>Software keanggotaan merupakan modul yang mengelola data anggota koperasi dan simpanan yang melekat pada keanggotaan.</strong></h4>
                            <div class="slider-btn">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1><strong>Module Sijaka</strong></h1>
                            <h4><strong>Simpanan berjaka merupakan simpanan yang diberikan untuk jangka waktu yang telah disepakati dan dana tidak bisa diambil sampai batas waktu tersebut.</strong></h4>
                            <div class="slider-btn">
...
<section class="clearfix about about-style">
    ...
    <div id="fh5co-why-us" class="animate-box">
        <div class="container" style="text-align: center;">
          <h2 style="margin-left: 0px;"><strong>LAYANAN <br>TEAM DATASOFT SOLUSI</strong></h2>
          <br>
          <br>
          <br>
            <div class="row">
                ...
                <div class="col-md-4 text-center item-block">
                    ...
                    <p><a href="<?php echo base_url().'home/simpanan'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p>
                </div>
                <div class="col-md-4 text-center item-block">
                    ...
                    <p><a href="<?php echo base_url().'home/sijaka'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p> <br> <br> <br> <br>
                </div>
                <div class="col-md-4 text-center item-block">
                    ...
                    <p><a href="<?php echo base_url().'home/kredit'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p>
                </div>
                <div class="col-md-4 text-center item-block">
                    <i class="fas fa-calculator fa-7x" style="color: blue"></i>
                    <h4><strong>SOFTWARE AKUNTANSI</strong></h4> <br>
                    <p>Software Akuntansi.</p> <br>
                    <p><a href="<?php echo base_url().'home/akuntansi'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p>
                </div>
                <div class="col-md-4 text-center item-block">
                    <i class="fas fa-database fa-7x" style="color: blue"></i>
                    <h4><strong>Database MIGRATION</strong></h4> <br>
                    <p>DATABASE MIgration</p> <br>
                    <p><a href="<?php echo base_url().'home/migration'?>" class="btn btn-info">BACA SELENGKAPNYA>></a></p>
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="row" style="margin-top: 0px;">
            <div class="col-md-6" style="margin-top: -20px;">
                ...
                <div class="col-md-4">
                    ...
                    <img id="imagePreview"a src="<?php echo base_url('assets/upload/image/'.$konfigurasi->g_footer1) ?>" style="margin-left: -185px; height: 70px; margin-top: 5px;">
        </div>
        <div class="col-md-4 col-sm-4">
          <div class="row" style="margin-top: 0px;">
            <div class="col-md-4" style="margin-top: -20px;">
                ...
                <div class="col-md-4">
                  <div class="bg-faded"> 
                <img id="imagePreview"a src="<?php echo base_url('assets/upload/image/'.$konfigurasi->g_footer1) ?>" style="margin-left: -185px; height: 70px; margin-top: 5px; width: 85px;">
                <a style="color: white; font-size: 15px;">Team DATASOFT SOLUSI</a>
              </div><br>
            </div><br>
            <div class="col-md-4">
                  <div class="bg-faded"> 
                <img id="imagePreview"a src="<?php echo base_url('assets/upload/image/'.$konfigurasi->g_footer2) ?>" style="margin-left: -185px; height: 70px; margin-top: 5px; width: 85px;">
