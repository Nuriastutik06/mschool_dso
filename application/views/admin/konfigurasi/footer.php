...
<head>
  ...
  <link rel="shorcut icon" type="text/css" href="<?php echo base_url().'assets/images/datasoft.png'?>">
...
<head>
  ...
  <title> DATASOFT | Dashboard</title>
  <!-- Tell the browser to be responsive to screen width -->
  <link rel="shorcut icon" type="text/css" href="<?php echo base_url().'theme/images/datasoft.png'?>">
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <!-- Bootstrap 3.3.6 -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="admin/konfigurasi">Konfigurasi</a></li>
...
<?php echo form_open_multipart(base_url('admin/konfigurasi/footer')) ?>
<div class="row">
  <input type="hidden" name="id_konfigurasi" value="<?php echo $konfigurasi->id_konfigurasi ?>">
    ...
    <div class="form-group">
      <label>Upload a new Image</label>
        <input type="file" name="g_footer1" class="form-control" id="file">
    </div>
    </div>
    
    <div class="col-md-6">
      <label>Your current Image</label><br>
        <img id="imagePreview"a src="<?php echo base_url('assets/upload/image/'.$konfigurasi->g_footer1) ?>" style="max-width:200px; height:auto;">
    </div>
...
<div class="row">
  <input type="hidden" name="id_konfigurasi" value="<?php echo $konfigurasi->id_konfigurasi ?>">
    ...
    <div class="form-group">
      <label>Upload a new Image</label>
        <input type="file" name="g_footer2" class="form-control" id="file">
    </div>
    </div>
    
    <div class="col-md-6">
      <label>Your current Image</label><br>
        <img id="imagePreview"a src="<?php echo base_url('assets/upload/image/'.$konfigurasi->g_footer2) ?>" style="max-width:200px; height:auto;">
    </div>
