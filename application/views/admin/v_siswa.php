...
<head>
  ...
  <title> DATASOFT | Data Staff dan Team</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Staff dan Team</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Staff dan Team</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <footer class="main-footer">
    ...
    <p><?php echo date('Y');?> © copyright by <a href="http://dso-id.com" target="_blank">DATASOFT SOLUSI</a>. <br>All rights reserved.</p>
  </footer>
